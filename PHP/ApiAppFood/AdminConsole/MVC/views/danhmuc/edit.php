        ...
        <div class="tile-body">
          ...
          <form class="row" action="./?mod=danhmuc&act=update" method="POST" role="form" enctype="multipart/form-data">
            <div class="form-group col-md-6">
              ...
              <input class="form-control" value="<?= $data['id'] ?>" type="hidden" name="id" placeholder="">
            </div>
            <div class="form-group col-md-6">
              <label class="control-label">Tên danh mục</label>
              <input class="form-control" name="tendanhmuc" value="<?= $data['tendanhmuc'] ?>" type="text">
            </div>
            <div class="form-group col-md-6">
              <label class="control-label">Ảnh cũ</label>
              <img src="<?= $data['hinhdanhmuc'] ?>" width="500" alt="">
            </div>
          
            <div class="form-group col-md-6">
              <label class="control-label">Link ảnh mới</label>
              <input class="form-control" name="hinhdanhmuc" type="text">
            </div>
